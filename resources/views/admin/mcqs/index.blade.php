...
<div class="card">
    <div class="d-flex justify-content-between border-bottom border-3 border-dark mb-3">
        ...
        <a href="{{ route('admin.questionoptions.create', $event_id) }}" class="btn btn-primary border-0 m-3">
    ...
    <div class="card-body">
        ...
        @forelse ($question_options as $qo)
            <div class="card accordion-item mb-3">
                ...
                <div id="accordion{{$qo->id}}" class="accordion-collapse border border-success collapse">
