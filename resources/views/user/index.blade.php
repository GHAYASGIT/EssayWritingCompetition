...
<div class="card">
    <div class="d-flex justify-content-between border-bottom border-3 border-dark mb-4">
        ...
        <a href="{{ route('user.create') }}" class="btn btn-primary border-0 m-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('user.destroy',$user->id) }}" method="POST">
                                    {{-- <a class="btn rounded-pill btn-icon btn-info" href="{{ route('user.show',$user->id) }}"><span class="tf-icons bx bx-show"></span></a> --}}
                                    <a class="btn btn-icon btn-outline-success" href="{{ route('user.edit',$user->id) }}"><span class="tf-icons bx bx-edit"></span></a>
                                    @csrf
                                    @method('DELETE')
